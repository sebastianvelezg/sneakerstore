      ...
      <div class="col-md-7">
        ...
        <div class="d-flex p-4 space between justify-content-between">
          <p>
            ...
            <span class="fw-bold mx-1">{{__'Product Sold'}}</span>13.450
          </p>
          <p>
            <i class="fa-solid fa-user"></i>
            <span class="fw-bold mx-1">{{__'Sneaker Request'}}</span>1.245
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="col-md-6">
            ...
            <p>
                ...
                <span class="fw-bold mx-1">{{__'Authentic'}}</span>100%
            </p>
            </div>
    ...
    <div class="container p-5 d-flex flex-column justify-content-center align-items-center">
      <div class="col-md-8 row my-5">
        ...
        <div class="col-md-4 d-flex flex-column justify-content-center align-items-center">
          ...
          <h3>Secure</h3>
          <p class="">{{__We preserve the integrity of our clients, and handle the information they provide us in an ethical and responsible manner.}}</p>
        </div>
        <div class="col-md-4 d-flex flex-column justify-content-center align-items-center">
