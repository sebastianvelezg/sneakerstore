...
<h1>Create Clothing {{ $viewData['category']->getName() }}</h1>
@stop
@section('content')
<form action="{{ route('admin.clotheStore') }}" enctype="multipart/form-data" method="POST">
  @method('POST')
  @csrf
  ...
  <div class="mb-3">
    <label for="" class="form-label">{{__'Release Date'}}</label>
    <div class="col-md-6">
  ...
  <div class="mb-3">
    <label for="" class="form-label">{{__'Retail Price'}}</label>
    <div class="col-md-6">
  ...
  <div class="mb-3">
    <label for="" class="form-label">{{__'Prise'}}</label>
    <div class="col-md-6">
  ...
  <button type="submit" class="btn bg-dark text-white">{{__'Save'}}</button>
</form>
@stop
